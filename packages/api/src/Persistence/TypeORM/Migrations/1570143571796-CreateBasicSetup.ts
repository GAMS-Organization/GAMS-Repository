...
export class CreateBasicSetup1570143571796 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `insert into users (id, name, surname, email, password, state) values (1, 'admin','admin','admin@gams.com','$2a$08$v8xzzauJ0ddu.Sz5XT5D2e9tVf.edterNiETOa361H8GRZcUwXVb6','active');`,
    );
    //Create user_roles
