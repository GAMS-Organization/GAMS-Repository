    ...
    if (!isError(status)) {
      ...
      return {
        ...
        error: {
          code: status,
          type: code,
          errors: 'Error al crear la herramienta. Por favor revise los campos ingresados.',
        },
      };
    }
  }
    ...
    if (!isError(status)) {
      ...
      return {
        ...
        error: {
          code: status,
          type: code,
          details: 'Error al actualizar la herramienta. Por favor revise los campos ingresados.',
        },
      };
    }
  }
    ...
    if (!isError(status)) {
      ...
      return {
        ...
        error: {
          code: status,
          type: code,
          details: 'Error al eliminar la herramienta. Por favor intente más tarde.',
        },
      };
    }
  }
